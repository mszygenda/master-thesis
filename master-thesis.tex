...
Pierwszym etapem w przypadku narzędzia Squeryl jest stworzenie odwzorowania struktury bazy danych. Definiuje się ją z wykorzystaniem zwykłych klas języka Scala oraz specjalnej klasy Schema. Przykładowa struktura (przykład z dokumentacji Squeryla\cite{squeryl_schemadefinition})
...
Wykorzystanie języka dziedzinowego do obsługi bazy danych daje duże możliwości.
