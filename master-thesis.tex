...
Znacząca przewaga neo4j wynika tutaj przede wszystkim z lokalności operacji wykonywanych na bazie grafowej (tj. nie musimy przeszukiwać wszystkich węzłów a jedynie te które są fizycznie połączone z interesującymi nas węzłami) w przeciwieństwie do bazy MySQL w której z każdą relacją musimy wykonać iloczyn kartezjański który wymaga przejrzenia całego zbioru danych.
